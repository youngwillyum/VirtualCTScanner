...
function phantom = generateCircularPhantom(matrixSize, phantomSize, phantomValue1, phantomValue2, phantomValue3, phantomValue4)
    ...
    centerOffsetsX = [-150, -100, -150, -120];
    centerOffsetsY = [-120, -100, -180, -200];
    circleStructsSI = [phantomValue1 phantomValue2 phantomValue3 phantomValue4];
    ...
    for i=1:numel(centerOffsetsX)
        ...
        mask = mask + (sqrt((x-centerX).^2 + (y-centerY).^2) < 15) * circleStructsSI(i);
    end
